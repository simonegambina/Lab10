...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        #ROW with controls
        self._txtAnno = ft.TextField(label="Anno", hint_text="Inserisci un anno tra 1816-2016")
        ...
        self._ddStato = ft.dropdown.Dropdown(label="Stato", hint_text="Seleziona uno stato",
                                             on_change=self._controller._choiceStato)
        self._btnStatiRag = ft.ElevatedButton(text="Stati raggiungibili",
                                              on_click=self._controller.handleRaggiungibili)
        row2 = ft.Row([self._ddStato, self._btnStatiRag], alignment=ft.MainAxisAlignment.CENTER)
